...
func SetRow() []*Attribute {
	...
	dataRows := []*Attribute{
		&Attribute{ID: 244, ObjectID: "datacenter", PropertyID: "bk_inst_name", PropertyIndex: 0, PropertyName: "实例名", PropertyGroup: groupBaseInfo, PropertyType: common.FieldTypeSingleChar, Option: nil, IsAPI: false, IsRequired: true, IsOnly: true, IsEditable: true, IsPre: true},
		&Attribute{ID: 245, ObjectID: "datacenter", PropertyID: "areaCode", PropertyIndex: 1, PropertyName: "区域编号", PropertyGroup: groupBaseInfo, PropertyType: common.FieldTypeSingleChar, Option: nil, IsAPI: false, IsRequired: false, IsOnly: false, IsEditable: true},
		&Attribute{ID: 246, ObjectID: "datacenter", PropertyID: "areaName", PropertyIndex: 2, PropertyName: "区域名称", PropertyGroup: groupBaseInfo, PropertyType: common.FieldTypeSingleChar, Option: nil, IsAPI: false, IsRequired: false, IsOnly: false, IsEditable: true},
		&Attribute{ID: 247, ObjectID: "datacenter", PropertyID: "datacenterCode", PropertyIndex: 3, PropertyName: "数据中心编号", PropertyGroup: groupBaseInfo, PropertyType: common.FieldTypeSingleChar, Option: nil, IsAPI: false, IsRequired: true, IsOnly: false, IsEditable: true},
		&Attribute{ID: 248, ObjectID: "datacenter", PropertyID: "datacenterName", PropertyIndex: 4, PropertyName: "数据中心名称", PropertyGroup: groupBaseInfo, PropertyType: common.FieldTypeSingleChar, Option: nil, IsAPI: false, IsRequired: false, IsOnly: false, IsEditable: true},
		&Attribute{ID: 249, ObjectID: "datacenter", PropertyID: "datacenterTypeCode", PropertyIndex: 5, PropertyName: "数据中心类型编号", PropertyGroup: groupBaseInfo, PropertyType: common.FieldTypeSingleChar, Option: nil, IsAPI: false, IsRequired: false, IsOnly: false, IsEditable: true},
		&Attribute{ID: 250, ObjectID: "datacenter", PropertyID: "datacenterTypeName", PropertyIndex: 6, PropertyName: "数据中心类型名称", PropertyGroup: groupBaseInfo, PropertyType: common.FieldTypeSingleChar, Option: nil, IsAPI: false, IsRequired: false, IsOnly: false, IsEditable: true},
		&Attribute{ID: 251, ObjectID: "datacenter", PropertyID: "jfgsCode", PropertyIndex: 7, PropertyName: "机房归属编号", PropertyGroup: groupBaseInfo, PropertyType: common.FieldTypeSingleChar, Option: nil, IsAPI: false, IsRequired: false, IsOnly: false, IsEditable: true},
		&Attribute{ID: 252, ObjectID: "datacenter", PropertyID: "jfgsName", PropertyIndex: 8, PropertyName: "机房归属名称", PropertyGroup: groupBaseInfo, PropertyType: common.FieldTypeSingleChar, Option: nil, IsAPI: false, IsRequired: false, IsOnly: false, IsEditable: true},
		&Attribute{ID: 253, ObjectID: "datacenter", PropertyID: "unifiedDatacenterCode", PropertyIndex: 9, PropertyName: "统一机房编号", PropertyGroup: groupBaseInfo, PropertyType: common.FieldTypeSingleChar, Option: nil, IsAPI: false, IsRequired: false, IsOnly: false, IsEditable: true},
		&Attribute{ID: 254, ObjectID: "datacenter", PropertyID: "usageStateNo", PropertyIndex: 10, PropertyName: "使用状态号", PropertyGroup: groupBaseInfo, PropertyType: common.FieldTypeSingleChar, Option: nil, IsAPI: false, IsRequired: false, IsOnly: false, IsEditable: true},
		&Attribute{ID: 255, ObjectID: "datacenter", PropertyID: "createdate", PropertyIndex: 11, PropertyName: "创建日期", PropertyGroup: groupBaseInfo, PropertyType: common.FieldTypeDate, Option: nil, IsAPI: false, IsRequired: false, IsOnly: false, IsEditable: true},

		&Attribute{ID: 256, ObjectID: "crm_dim_product", PropertyID: "bk_inst_name", PropertyIndex: 0, PropertyName: "实例名", PropertyGroup: groupBaseInfo, PropertyType: common.FieldTypeSingleChar, Option: nil, IsAPI: false, IsRequired: true, IsOnly: true, IsEditable: true, IsPre: true},
