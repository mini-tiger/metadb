...
func getObjectDesData(ownerID string) []*metadata.Object {
	...
	dataRows := []*metadata.Object{
		&metadata.Object{IsCache: true, ObjCls: "digitization", ObjectID: "datacenter", ObjectName: "数据中心-数字化项目", ObjIcon: "icon-cc-engine-room", IsPre: false, IsHidden: false, IsPaused: false},
		&metadata.Object{IsCache: false, ObjCls: "digitization", ObjectID: "crm_dim_product", ObjectName: "产品线", ObjIcon: "icon-cc-triangle", IsPre: false, IsHidden: false, IsPaused: false},
...
func getPropertyGroupData(ownerID string) []*metadata.Group {
	...
	dataRows := []*metadata.Group{
		//netdata
		&metadata.Group{BizID: 0, ObjectID: "datacenter", GroupID: "default", GroupName: "Default", GroupIndex: -1, OwnerID: ownerID, IsDefault: true, IsPre: false, IsCollapse: false, ID: 59},

		&metadata.Group{BizID: 0, ObjectID: "crm_dim_product", GroupID: "default", GroupName: "Default", GroupIndex: -1, OwnerID: ownerID, IsDefault: true, IsPre: false, IsCollapse: false, ID: 61},
...
var classificationRows = []*metadata.Classification{
	...
	&metadata.Classification{ClassificationID: "digitization", ClassificationName: "数字化项目", ClassificationType: "inner", ClassificationIcon: "icon-cc-network-equipment"},
}
