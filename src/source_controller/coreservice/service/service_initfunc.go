...
func (s *coreService) initModelInstances(web *restful.WebService) {
	...
	utility.AddHandler(rest.Action{Verb: http.MethodPost, Path: "/read/model/{bk_obj_id}/instances/asst", Handler: s.SearchModelInstancesAsst})
	...
	//utility.AddHandler(rest.Action{Verb: http.MethodDelete, Path: "/deleteskiparchive/model/{bk_obj_id}/instance/cache", Handler: s.DeleteSkipArchiveModelInstances})
	utility.AddToRestfulWebService(web)
}
