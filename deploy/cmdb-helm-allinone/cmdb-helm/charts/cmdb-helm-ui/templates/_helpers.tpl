...
{{- define "lmanager-cmdb-ui.image" -}}
{{- if .Values.global.ui.repository }}
{{ .Values.global.ui.repository }}:{{ .Values.global.ui.tag | default .Chart.AppVersion }}
{{- else }}
...
{{- define "lmanager-cmdb-ui.resources" -}}
{{- if .Values.global.ui.resources }}
{{- toYaml .Values.global.ui.resources | nindent 12 }}
{{- else }}
