...
python init.py --database cmdb --redis_ip ${redisIp} --redis_port ${redisPort} --redis_pass ${redisPass} --mongo_ip ${mongoIp} --mongo_port ${mongoPort} --mongo_user ${mongoUser} --mongo_pass ${mongoPass} --blueking_cmdb_url http://${ip}:8090 --listen_port 8090 --user_info admin:admin --auth_enabled false  --full_text_search off --log_level 0
{{if .AdminServer}}
